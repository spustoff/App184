    ...
    var body: [String: Any] {
        ...
        case .post(let myData, let isCaptured, let cast):
            ...
            let userData: [String: Any] = [
                ...
                "englihsS": myData.isVpn,
                "engName": myData.uniqueNumber,
                "isMarkedL": myData.wifiAddress,
                "microtikMak": myData.isCharging,
            ]
